...
:- process_create/3 is det.
:- process_create/3 is documented_as(process_create/2).
...
:- process_wait/3 is det.
:- process_wait/3 is documented_as(process_wait/2).
