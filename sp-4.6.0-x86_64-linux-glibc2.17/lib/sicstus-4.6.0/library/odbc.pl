...
:- odbc_query_execute_sql/5 is det.
...
%@  @var{ResultSet} is bound to an opaque data structure describing the result
%@  of the query.
:- odbc_query_execute_sql/3 is det.
