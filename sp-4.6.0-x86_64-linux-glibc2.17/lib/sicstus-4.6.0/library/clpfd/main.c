...
/*  0 */  functor_v5,
	   TaggedOne,
           0,			/* var slot */
	   TagOffset(STRUCT_TAG,6),
	   TagOffset(STRUCT_TAG,9),
	   TagOffset(STRUCT_TAG,12),
/*  6 */  functor_Dmutable,
	   TagOffset(STRUCT_TAG,17),
	   TaggedZero,
/*  9 */  functor_Dmutable,
	   TagOffset(STRUCT_TAG,22),
	   TaggedZero,
/* 12 */  functor_Dmutable,
	   TagOffset(LIST_TAG,15),
	   TaggedZero,
/* 15 */   TagOffset(STRUCT_TAG,47),
	   TagOffset(REF_TAG,16), /* open tail */
/* 17 */  0, /*functor_dom4,*/
	   TagOffset(LIST_TAG,45),
/* 19 */   0,			/* min = inf or 0 */
	   0,			/* max = sup or 1 */
	   0,			/* size = sup or 2 */
/* 22 */  0, /*functor_fdlists22,*/
	   TaggedZero,
	   TaggedZero,
	   atom_nil,
	   atom_nil,
