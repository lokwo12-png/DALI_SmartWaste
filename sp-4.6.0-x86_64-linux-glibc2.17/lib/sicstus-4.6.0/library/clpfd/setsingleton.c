...
enum var_choice {
  min=0, max, ff, ffc, aff, occ, mreg, leftmost
};
...
#define Encoding_leftmost   0x00001
#define Encoding_min        0x00002
#define Encoding_max        0x00004
#define Encoding_ff         0x00008
#define Encoding_ffc        0x00010
#define Encoding_anti_ff    0x00020
#define Encoding_occurrence 0x00040
#define Encoding_max_regret 0x00080
#define Encoding_enum       0x00100
#define Encoding_step       0x00200
#define Encoding_bisect     0x00400
#define Encoding_up         0x01000
#define Encoding_down       0x02000
#define Encoding_median     0x04000
#define Encoding_middle     0x08000
#define Encoding_minimize   0x10000
#define Encoding_maximize   0x20000
