...
#if __APPLE__ && !(SP_DONT_SUPPRESS_TCLTK_DEPRECATION + 0)
/* error: ... is deprecated: first deprecated in macOS 10.15 - Tk API deprecated. [-Werror,-Wdeprecated-declarations] */
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
#endif	/* __APPLE__ && !(SP_DONT_SUPPRESS_TCLTK_DEPRECATION + 0) */
...
static int Aqua_EnableForegroundoperationCPS(char const *app_name)
{
  ...
  /* [PM] 3.10.1 FIXME: Should we do this or not? I do not know wha
