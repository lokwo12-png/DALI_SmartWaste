...
%@  sparingly.
:- comclient_garbage_collect/0 is det.
comclient_garbage_collect :-
...
:- comclient_is_object/1 is semidet.
...
%@  SICStus Prolog.
:- comclient_valid_object/1 is semidet.
...
:- comclient_clsid_from_progid/2 is det.
comclient_clsid_from_progid(ProgID, CLSID) :-
   WantAtom = true,
   comclient_clsid_from_progid(ProgID, CLSID, WantAtom).

% Do not use comclient_clsid_from_progid/3. Use comclient_clsid_from_progid/2 instead.
:- comclient_clsid_from_progid/3 is det.
comclient_clsid_from_progid(ProgID, CLSID, WantAtom) :-
...
%@  @end group
%@  @end example
:- comclient_progid_from_clsid/2 is det.
comclient_progid_from_clsid(CLSID, ProgID) :-
   WantAtom = true,
   comclient_progid_from_clsid(CLSID, ProgID, WantAtom).

% Do not use comclient_progid_from_clsid/3. Use comclient_progid_from_clsid/2 instead.
:- comclient_progid_from_clsid/3 is det.
comclient_progid_from_clsid(CLSID, ProgID, WantAtom) :-
...
%@  @end group
%@  @end example
:- comclient_iid_from_name/2 is det.
comclient_iid_from_name(InterfaceName, IID) :-
   WantAtom = true,
   comclient_iid_from_name(InterfaceName, IID, WantAtom).

% Do not use comclient_iid_from_name/3. Use comclient_iid_from_name/2 instead.
:- comclient_iid_from_name/3 is det.
comclient_iid_from_name(InterfaceName, IID, WantAtom) :-
...
:- comclient_name_from_iid/2 is det.
comclient_name_from_iid(IID, InterfaceName) :-
   WantAtom = true,
   comclient_name_from_iid(IID, InterfaceName, WantAtom).

% Do not use comclient_name_from_iid/3. Use comclient_name_from_iid/2 instead.
:- comclient_name_from_iid/3 is det.
comclient_name_from_iid(IID, InterfaceName, WantAtom) :-
...
:- comclient_create_instance/2 is det.
...
:- comclient_get_active_object/2 is det.
...
:- comclient_invoke_method_fun/3 is det.
...
:- comclient_invoke_method_proc/2 is det.
...
%@  @end group
%@  @end example
:- comclient_is_exception/1 is semidet.
...
:- comclient_exception_code/2 is det.
...
:- comclient_exception_culprit/2 is det.
...
:- comclient_exception_description/2 is det.
