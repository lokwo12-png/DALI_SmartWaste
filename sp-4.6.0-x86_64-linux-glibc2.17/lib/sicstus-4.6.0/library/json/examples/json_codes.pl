...
%% This example module provides convenience utilities for converting JSON text,
%% represented as an atom or a list of character codes,
%% to and from the corresponding Prolog term representation.
%%
:- module(json_codes, [json_to_codes/2,json_to_codes/3,
                       json_to_atom/2,json_to_atom/3,
                       json_from_codes/2,json_from_codes/3,
