...
/* SP_set_memalloc_hooks() was deprecated in SP 4.5.0, it may be removed in a future release. */
extern SPEXP(77) SPEXPFLAG_PREINIT SPEXPFLAG_HIDDEN SPEXPFLAG_OLDHOOKS int SPCDECL
