...
#define SICSTUS_MINOR_VERSION 6
...
/* [PD] 3.11.1 */
#define SICSTUS_VERSION_STRING "4.6.0"
...
#define SP_GET_DISPATCH_NAME SP_get_dispatch_40600
...
#define SP_RTSYS_DIRNAME "sp-4.6.0"
#define SP_EMULATOR_DIRNAME "sicstus-4.6.0"
/* [PM] 3.11.0 */
#define LICENSE_PRODUCT "sicstus4.6_linux"
...
#define RTKERNEL_BASENAME_WITH_DSO_SUFFIX_STRING "libsprt4-6-0.so"
...
/* Something like "libsprt-4-1-2-instance-XX.so". Must contain exactly
   ...
   literal string) */
#define RTKERNEL_INSTANCE_TEMPLATE_STRING "libsprt4-6-0-instance-XX"
...
#if !defined(FIX_SPRM_20192)
#define FIX_SPRM_20192 1
#endif	/* !defined(FIX_SPRM_20192) */
